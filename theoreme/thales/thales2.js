function thales2()
{
var x = document.getElementById("cote1g").value;
var y = document.getElementById("cote1p").value;
...
if((x > 0) && (y > 0) && (z > 0) && (verif >= 1)) {
  document.getElementById("resultat").innerHTML="EB : " + y + " * " + z + " / " + x + " = " + Math.round(res*10000)/10000
}
else {
